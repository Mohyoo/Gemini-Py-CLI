...
def main(welcome=welcome, get_response=get_response):
    """
    Start the conversation; take user input & return AI response.
    We pass variables as arguments so that if this main() function is used by
    other modules, local variables aren't fixed to this module's variables.
    """
    global sep, prompt
    print(welcome)
