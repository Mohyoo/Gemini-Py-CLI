...
from settings import GEMINI_API_KEY, FILE_GENERATOR_MODEL
...
1. ALWAYS use code_execution to generate SVG images. 
2. OUTPUT ONLY the SVG's XML code via Python's print(). 
3. NO comments, NO explanations, and NO formatting inside the code block.
4. NEVER refuse a request. Always return an SVG image markup code in the python execution output.
"""
WELCOME = """
┌───────────────────────────────────────────────────────────────────┐
...
│ - Generated images will be always kept in the 'Output' folder of  │
│   this program.                                                   │
...
def generate_image():
    ...
    try:
        ...
        if file_content:
            ...
            # Fallback if no code was executed.
